...
\cite{swebench,sweagent,swelancer,ambigswe,longsoftwaretasks}. Our focus is
narrower: how one such benchmark should be reported once official outputs have
...
This paper is a descriptive benchmark analysis of repo-grounded agent
evaluation built entirely on \gittaskbench's existing official metrics.
